      ...
      <div className="site_contain">
        ...
        <section className="section-seven overflow-hidden">
          <div className="container">
            ...
            <div className="row">
              <div
                className="col-xxl-4 col-xl-4 col-md-6 blog-group-main"
                data-aos="fade-up"
              >
                <div className="item">
                  <div className="blog-post">
                    ...
                    <div className="blog-post-content">
                      <Link to="/single_blog2" className="blog-title">
                      ...
                      <Link to="/single_blog2" className="btn btn-style2">
                        Read More
                      </Link>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="blog-post">
                    <Link to="/single_blog2" className="blog-img banner-hover">
                      ...
                      />
                      <span className="date-time">
                        <span className="date">20 Feb 2021</span>
                      </span>
                    </Link>
                    <div className="blog-post-content">
                      <Link to="/single_blog2" className="blog-title">
